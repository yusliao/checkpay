...
- **2026-03-23 00:00:00** - 扣款记录新增手写金额字段：DebitRecord 加 WrittenAmount（decimal?，手写金额），新建 EF 迁移 AddWrittenAmountToDebitRecord；DebitImport 录入表单增加"手写金额"可选输入；ExceptionList 未匹配扣款+存疑支票均显示支票金额/扣款金额/手写金额；ReviewList/ReviewDetail 新增手写金额列/行；CheckRecords 列表新增扣款金额列，Drawer 详情展示扣款金额/手写金额
